...
for tool in java go python node c cpp lua git gh tmux micro lazygit tree ttt htop ncdu inxi speedtest-cli posting yazi tuifi neovim opencode-cli codex-cli claudecode-cli; do
